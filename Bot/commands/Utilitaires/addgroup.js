...
module.exports.run = async (client, message, args) => {
    ...
    if (guild.groups.includes(groupe)) return message.reply('Merci d\'indiquer un nom groupe différent de ceux déjà donnés ! Regarde tous les groupes enregistrés avec la commande `groups`')
