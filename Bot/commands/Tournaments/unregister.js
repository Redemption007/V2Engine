...
module.exports.run = async (client, message) => {
    ...
    try {
        ...
        message.guild.channels.get(settings.logchannel).send(`Ce ksos de <@${message.author.id}> a autorisé les DMs du bot mais pas ceux du serveur (paramètres de confidentialité)`)
    }

    return message.reply({embed: {color: 'DARK_GREEN', title: 'Désinscription réussie !', description: 'Vous avez été désinscrits avec succès de ce tournoi.'}, reply: message.author})
}
